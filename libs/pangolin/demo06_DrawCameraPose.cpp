/*
 * @Author: Divenire
 * @Date: 2021-09-20 15:02:15
 * @LastEditors: Divenire
 * @LastEditTime: 2021-09-20 16:02:23
...
const char * dataset_path= "/home/divenire/Divenire_ws/dataset/EuRoC/MH_01_easy/mav0/state_groundtruth_estimate0/data.csv";

int main(int argc, char **argv)
{
     // 请自行修改数据集路径
    FILE *fp_gt = fopen(dataset_path,"r");
    ...
    // 初始化视窗
    pangolin::CreateWindowAndBind("camera_pose", 640, 480 );
    // 启用深度测试
    glEnable(GL_DEPTH_TEST);

    pangolin::OpenGlRenderState s_cam_ = pangolin::OpenGlRenderState(
        pangolin::ProjectionMatrix(640, 480, 420, 420, 320, 240, 0.1, 1000),
        pangolin::ModelViewLookAt(50, -30, 50, 0, 0, 0, pangolin::AxisZ));
